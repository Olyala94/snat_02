                        ...
                        <div
                            ...
                            <div class="item p-a5">
                                <div class="testimonial-9">
                                    <div class="testimonial-pic radius style1"><img
                                            src="/images/sart/kas_laminasyon_5.webp" width="100" height="100"
                                            alt=""></div>
                                    <div class="testimonial-text">
                                        <p>@lang('about.about_us_client_comments1')</p>
                                    </div>
                                    <div class="testimonial-detail"> <strong class="testimonial-name">Ayşe K.</strong>
                                        <span class="testimonial-position">@lang('about.about_us_client_job1')></span> </div>
                                </div>
                            </div>
                            <div class="item p-a5">
                                <div class="testimonial-9">
                                    <div class="testimonial-pic radius style1"><img
                                            src="/images/sart/gelin_topuzu_1.webp" width="100" height="100"
                                            alt=""></div>
                                    <div class="testimonial-text">
                                        <p>@lang('about.about_us_client_comments2')</p>
                                    </div>
                                    <div class="testimonial-detail"> <strong class="testimonial-name">Zeynep Y.</strong>
                                        <span class="testimonial-position">@lang('about.about_us_client_job2')</span>
                                    </div>
                                </div>
                            </div>
                            <div class="item p-a5">
                                <div class="testimonial-9">
                                    ...
                                    <div class="testimonial-detail"> <strong class="testimonial-name">Selin A.</strong>
                                        <span class="testimonial-position">@lang('about.about_us_client_job3')</span>
                                    </div>
                                </div>
                            </div>
                            <div class="item p-a5">
                                <div class="testimonial-9">
                                    <div class="testimonial-pic radius style1"><img
                                            src="/images/sart/protez_tırnak_2.webp" width="100" height="100"
                                            alt="Aýdym-Saz "></div>
                                    <div class="testimonial-text">
                                        <p>@lang('about.about_us_client_comments4')</p>
                                    </div>
                                    <div class="testimonial-detail"> <strong class="testimonial-name">Elif S.</strong>
                                        <span class="testimonial-position">@lang('about.about_us_client_job4')</span> </div>
                                </div>
                            </div>
                            <div class="item p-a5">
                                <div class="testimonial-9">
                                    <div class="testimonial-pic radius style1"><img
                                            src="/images/sart/ipek_kirpik_3.webp" width="100" height="100"
                                            alt=""></div>
                                    <div class="testimonial-text">
                                        <p>@lang('about.about_us_client_comments5')</p>
                                    </div>
                                    <div class="testimonial-detail"> <strong class="testimonial-name">Suzan B.</strong>
                                        <span class="testimonial-position">@lang('about.about_us_client_job5')</span>
                                    </div>
                                </div>
                            </div>
                        </div>
