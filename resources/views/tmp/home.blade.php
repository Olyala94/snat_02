                 ...
                 <div id="rev_slider_265_1" class="rev_slider fullwidthabanner" style="display:none;"
                     ...
                     <ul> <!-- SLIDE  -->
                         <li data-index="rs-300" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                             ...
                             data-thumb="{{ asset('images/nur-art-img/ceramics-children-01.webp') }}" data-rotate="0"
                             data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3=""
                             data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9=""
                             data-param10="" data-description="">
                             <!-- MAIN IMAGE -->
                             <img src="{{ asset('images/nur-art-img/ceramics-children-01.webp') }}"
                                 alt="eyelash_lifting" data-bgposition="center center" data-bgfit="cover"
                                 data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina style="opacity: 0.7;">
                         ...
                         <li data-index="rs-200" data-transition="fade" data-slotamount="default"
                             ...
                             data-thumb="{{ asset('images/nur-art-img/nur-art-01.png') }}" data-rotate="0"
                             data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                             data-param3="" data-param4="" data-param5="" data-param6="" data-param7=""
                             data-param8="" data-param9="" data-param10="" data-description="">
                             <!-- MAIN IMAGE -->
                             <img src="{{ asset('images/nur-art-img/nur-art-01.png') }}"
                                 alt="index_slide_2_img_title_academy" data-bgposition="center center"
                             ...
                             <div class="tp-caption tp-resizeme" id="slide-200-layer-5"
                                 ...
                                 <a href="{{ uniqRt('our-courses') }}" class="site-button button-md"
                                     title="@lang('home.index_slide_2_services_button_academy')" target="_blank" rel="nofollow">@lang('home.our_courses')</a>
                             ...
                             <div class="tp-caption tp-resizeme" id="slide-200-layer-6"
                                 ...
                                 data-paddingright="[0]" data-paddingbottom="[0]" data-paddingleft="[0]"
                                 style="z-index: 11; white-space: nowrap; font-size: 16px; line-height: 30px; font-weight: 600; font-family:Montserrat;border-radius:3px 3px 3px 3px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">
                                 <a href="https://api.whatsapp.com/send?phone=99365675732"
                                     class="site-button-secondry button-md" title="@lang('home.whatsapp_line')"
                                     target="_blank" rel="nofollow">@lang('home.whatsapp')
                                 </a>
                             </div>
                         </li>
                         ...
                         <li data-index="rs-100" data-transition="fade" data-slotamount="default"
                             data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                             data-easeout="default" data-masterspeed="300"
                             data-thumb="{{ asset('images/nur-art-img/nur-art-04.png') }}" data-rotate="0"
                             data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
                             data-param3="" data-param4="" data-param5="" data-param6="" data-param7=""
                             data-param8="" data-param9="" data-param10="" data-description="">
                             <!-- MAIN IMAGE - 01-->
                             <img src="{{ asset('images/nur-art-img/nur-art-04.png') }}" alt="sart_academy"
                 ...
                 <div class="section-head text-black text-center">
                     <div class="dlab-separator-outer m-b0">
                         <div class="dlab-separator text-primary style-icon"><img
                                 src="/images/nur-art-logos/nur-art-logo-06.png" alt="@lang('home.sart_academy')">
                         </div>
                     </div>
                 ...
                 <div
                         ...
                         <div class="service-box text-center">
                             <div class="service-images m-b15">
                                 <img width="300" height="300"
                                     src="{{ asset('images/nur-art-img/nur-art-09.png') }}"
                     ...
                     <div class="item">
                         <div class="service-box text-center">
                             <div class="service-images m-b15">
                                 <img width="300" height="300"
                                     src="{{ asset('images/nur-art-img/date-pottery-02.png') }}"
                     ...
                     <div class="item">
                         <div class="service-box text-center">
                             <div class="service-images m-b15">
                                 <img width="300" height="300"
                                     src="{{ asset('images/nur-art-img/nur-art-010.png') }}"
                     ...
                     <div class="item">
                         <div class="service-box text-center">
                             <div class="service-images m-b15">
                                 <img width="300" height="300"
                                     src="{{ asset('images/nur-art-img/nur-art-023.png') }}"
                     ...
                     <div class="item">
                         <div class="service-box text-center">
                             <div class="service-images m-b15">
                                 <img width="300" height="300"
                                     src="{{ asset('images/nur-art-img/nur-art-013.png') }}"
         ...
         <div class="section-full content-inner-2 our-portfolio">
             <div class="container">
                 <div class="section-head text-black text-center m-b20">
                     <div class="dlab-separator-outer m-b0">
                         <div class="dlab-separator text-primary style-icon"><img
                                 src="{{ asset('images/nur-art-logos/nur-art-logo-06.png') }}"
                                 ...
                                 <div class="dlab-media dlab-img-overlay9 dlab-img-effect zoom">
                                     ...
                                     <div class="overlay-bx">
                                         <div class="overlay-icon">
                                             <span
                                                 data-exthumbimage="{{ asset('images/nur-art-img/nur-art-01.png') }}"
                             ...
                             <div class="dlab-box p-tb30 image-2">
                                 <div class="dlab-media dlab-img-overlay9 dlab-img-effect zoom">
                                     ...
                                     <div class="overlay-bx">
                                         <div class="overlay-icon">
                                             <span
                                                 data-exthumbimage="{{ asset('images/nur-art-img/nur-art-02.png') }}"
