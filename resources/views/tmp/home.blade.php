                    ...
                    <ul> <!-- SLIDE  -->
                        ...
                        <li data-index="rs-300" data-transition="fade" data-slotamount="default"
                            ...
                            <div class="tp-caption tp-resizeme" id="slide-300-layer-6"
                                ...
                                data-paddingright="[0]" data-paddingbottom="[0]" data-paddingleft="[0]"
                                style="z-index: 11; white-space: nowrap; font-size: 16px; line-height: 30px; font-weight: 600; font-family:Montserrat;border-radius:3px 3px 3px 3px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">
                                <a href="https://www.instagram.com/studio_ceramic_tm"
                    ...
                    <ul id="masonry"
                        ...
                        <li class="image-1  card-container col-lg-3 col-md-3 col-sm-3">
                                    ...
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            <span data-exthumbimage="{{  asset('images/sart/kaynak_sac_sq.webp') }}"
                                                data-src="{{ asset('images/sart/kaynak_sac_sq.webp') }}" class="icon-bx-xs check-km"
                            ...
                            <div class="dlab-box p-tb30 image-2">
                                <div class="dlab-media dlab-img-overlay9 dlab-img-effect zoom">
                                    <img width="385" height="385"img src="{{ asset('/images/sart/sac_islemleri.webp') }}"
                                        alt="@lang('home.hair_dye')">
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            <span data-exthumbimage="{{ asset('images/sart/sac_islemleri.webp') }}"
                                                data-src="{{ asset('images/sart/sac_islemleri.webp') }}" class="icon-bx-xs check-km"
                        ...
                        <li class="image-2 card-container col-lg-6 col-md-6 col-sm-6">
                            <div class="dlab-box m-b30">
                                <div class="dlab-media dlab-img-overlay9 dlab-img-effect zoom">
                                    <img src="{{ asset('/images/sart/kirpik_tasarim.webp') }}" alt="@lang('home.silk_eyelash')">
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            <span data-exthumbimage="{{ asset('/images/sart/kirpik_tasarim.webp') }}"
                                                data-src="{{ asset('/images/sart/kirpik_tasarim.webp') }}"
                        ...
                        <li class="image-3 image-4 card-container col-lg-3 col-md-3 col-sm-3">
                            <div class="dlab-box m-b30">
                                <div class="dlab-media dlab-img-overlay9 dlab-img-effect zoom">
                                    <img width="385" height="385"img src="{{ asset('/images/sart/tirnak_manikur.webp') }}"
                                        alt="@lang('home.mani_pedi')">
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            <span data-exthumbimage="{{ asset('/images/sart/tirnak_manikur.webp') }}"
                                                data-src="{{ asset('/images/sart/tirnak_manikur.webp') }}"
                            ...
                            <div class="dlab-box">
                                <div class="dlab-media dlab-img-overlay9 dlab-img-effect zoom">
                                    <img width="385" height="385"img src="{{ asset('/images/sart/kirpik_bakim.webp') }}"
                                        alt="@lang('home.solarium')">
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            <span data-exthumbimage="{{ asset('/images/sart/kirpik_bakim.webp') }}"
                                                data-src="{{ asset('/images/sart/kirpik_bakim.webp') }}" class="icon-bx-xs check-km"
        ...
        <div class="section-full content-inner-2 overlay-white-middle"
            ...
            <div class="container">
                <div class="section-head text-black text-center">
                    <div class="dlab-separator-outer m-b0">
                        <div class="dlab-separator text-primary style-icon"><img src="/images/sart/logo_fav.png"
                                alt="@lang('home.index_section4_img_alt')">
                        </div>
                    </div>
                ...
                <div class="section-head text-black text-center">
                    <div class="dlab-separator-outer m-b0">
                            <div class="dlab-separator text-primary style-icon"><img
                                src="/images/sart/logo-transparent.png" alt="@lang('home.index_section5_img_alt')">
                            </div>
                    </div>
                ...
                <div class="testimonial-two-dots owl-carousel owl-theme owl-dots-primary-full owl-btn-center-lr owl-btn-3">
                    ...
                    <div class="item p-a5">
                        <div class="testimonial-9">
                            <div class="testimonial-pic radius style1"><img src="/images/sart/kas_laminasyon_5.webp" alt="@lang('home.index_section5_main_title')"></div>
                            <div class="testimonial-text">
                                <p>@lang('home.about_us_client_comments1')</p>
                            </div>
                            <div class="testimonial-detail"> <strong class="testimonial-name">Ayşe K.</strong><span class="testimonial-position">@lang('home.about_us_client_job1')</span></div>
                        </div>
                    </div>
                    ...
                    <div class="item p-a5">
                        <div class="testimonial-9">
                            <div class="testimonial-pic radius style1"><img src="/images/sart/gelin_topuzu_1.webp" alt="@lang('home.index_section5_img_alt')"></div>
                            <div class="testimonial-text">
                                <p>@lang('home.about_us_client_comments2')</p>
                            </div>
                            <div class="testimonial-detail"> <strong class="testimonial-name">Zeynep Y.</strong> <span class="testimonial-position">@lang('home.about_us_client_job2')</span></div>
                        </div>
                    </div>
                    ...
                    <div class="item p-a5">
                        <div class="testimonial-9">
                            <div class="testimonial-pic radius style1"><img src="/images/sart/dip_boyası_4.webp" alt="@lang('home.')"></div>
                            <div class="testimonial-text">
                                <p>@lang('home.about_us_client_comments3')</p>
                            </div>
                            <div class="testimonial-detail"> <strong class="testimonial-name">Selin A.</strong><span class="testimonial-position">@lang('home.about_us_client_job3')</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="item p-a5">
                        <div class="testimonial-9">
                            <div class="testimonial-pic radius style1"><img src="/images/sart/protez_tırnak_2.webp" alt="@lang('home.')"></div>
                            <div class="testimonial-text">
                                <p>@lang('home.about_us_client_comments4')</p>
                            </div>
                            <div class="testimonial-detail"> <strong class="testimonial-name">Elif S.</strong> <span class="testimonial-position">@lang('home.about_us_client_job4')</span> </div>
                        </div>
                    </div>
                    ...
                    <div class="item p-a5">
                        <div class="testimonial-9">
                            <div class="testimonial-pic radius style1"><img src="/images/sart/ipek_kirpik_3.webp" alt="@lang('home.')"></div>
                            <div class="testimonial-text">
                                <p>@lang('home.about_us_client_comments5')</p>
                            </div>
                            <div class="testimonial-detail"> <strong class="testimonial-name">Suzan B.</strong><span class="testimonial-position">@lang('home.about_us_client_job5')</span></div>
                        </div>
                    </div>
                </div>
