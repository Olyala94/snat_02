                    ...
                    <ul> <!-- SLIDE  -->
                        <li data-index="rs-300" data-transition="fade" data-slotamount="default"
                            ...
                            <div class="tp-caption tp-resizeme text-primary" id="slide-300-layer-2"
                                ...
                                data-frames='[{"delay":"+500","split":"chars","splitdelay":0.05000000000000000277555756156289135105907917022705078125,"speed":2000,"split_direction":"forward","frame":"0","from":"opacity:0.7;","color":"#000000","to":"o:1;","ease":"Power4.easeInOut"},{"delay":"wait","speed":2000,"frame":"999","color":"transparent","to":"opacity:0.7;","ease":"Power3.easeInOut"}]'
                                data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]"
                                data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
                                data-paddingleft="[0,0,0,0]"
                                ...
                                @lang('home.index_slide_3_1_academy')
                            </div>
                            <div class="tp-caption tp-resizeme text-primary" id="slide-300-layer-3"
                                ...
                                style="z-index: 7; white-space: nowrap; font-size: 65px; line-height: 80px; font-weight: 600; letter-spacing: 0px; font-family:Poppins;">
                                @lang('home.index_slide_3_2_academy')</div>
                            <!-- LAYER NR. 2 -->
                            <div class="tp-caption tp-resizeme" id="slide-300-layer-4"
                                ...
                                data-responsive_offset="on"
                                data-frames='[{"delay":"+1990","speed":2000,"frame":"0","from":"opacity:0.7;","color":"#d9a86d","to":"o:1;","ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"frame":"999","color":"transparent","to":"opacity:0.7;","ease":"Power3.easeInOut"}]'
                                ...
                                @lang('home.index_slide_3_3_academy')
                            </div>
                            <!-- LAYER NR. 6 -->
                            <div class="tp-caption tp-resizeme" id="slide-300-layer-5"
                                ...
                                <a href="https://goo.gl/maps/MLkCjkQovNnJvqrw6" class="site-button button-md" title="@lang('home.index_slide_3_navigation_button')" target="_blank" rel="nofollow">@lang('home.index_slide_3_navigation_button')</a>
                            </div>
                        ...
                        <li data-index="rs-200" data-transition="fade" data-slotamount="default"
                            data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                            data-easeout="default" data-masterspeed="300" data-thumb="{{ asset('images/nur-art-img/nur-art-01.png') }}"
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="{{ asset('images/nur-art-img/nur-art-01.png') }}" alt="index_slide_2_img_title_academy"
                                data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                            ...
                            <div class="tp-caption tp-resizeme text-primary" id="slide-200-layer-2"
                                ...
                                data-paddingleft="[0,0,0,0]"
                                style="z-index: 7; white-space: nowrap; font-size: 65px; line-height: 80px; font-weight: 600; letter-spacing: 0px; font-family:Poppins;">
                                @lang('home.index_slide_2_1_academy')</div>
                            <div class="tp-caption tp-resizeme text-primary" id="slide-200-layer-3"
                                ...
                                data-paddingleft="[110,110,110,110]"
                                style="z-index: 7; white-space: nowrap; font-size: 65px; line-height: 80px; font-weight: 600; letter-spacing: 0px; font-family:Poppins;">
                                @lang('home.index_slide_2_2_academy')</div>
                            <!-- LAYER NR. 2 -->
                            <div class="tp-caption   tp-resizeme" id="slide-200-layer-4"
                                ...
                                data-paddingleft="[0,0,0,0]"
                                style="z-index: 6; font-size: 18px; line-height: 28px; font-weight: 500; color: #fff; white-space: inherit; font-family:Poppins;">
                                @lang('home.index_slide_2_3_academy')
                            </div>
                            <!-- LAYER NR. 6 -->
                            <div class="tp-caption tp-resizeme" id="slide-200-layer-5"
                                ...
                                data-paddingright="[0]" data-paddingbottom="[0]" data-paddingleft="[0]"
                                style="z-index: 10; white-space: nowrap; font-size: 16px; line-height: 30px; font-weight: 600; font-family:Montserrat;border-radius:3px 3px 3px 3px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">
                                {{-- <a href="{{ uniqRt('our-courses') }}" class="site-button button-md" title="@lang('home.index_slide_2_services_button_academy')" target="_self">@lang('home.our_courses')</a> --}}
                                <a href="{{ uniqRt('our-courses') }}" class="site-button button-md" title="@lang('home.index_slide_2_services_button_academy')" target="_blank" rel="nofollow">@lang('home.our_courses')</a>
                            ...
                            <div class="tp-caption tp-resizeme" id="slide-200-layer-6"
                                ...
                                <a href="https://api.whatsapp.com/send?phone=905335085191"
                                    ...
                                    rel="nofollow">@lang('home.whatsapp')
                                </a>
                            </div>
                        </li>
                        ...
                        <li data-index="rs-100" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                            ...
                            data-masterspeed="300" data-thumb="{{ asset('images/nur-art-img/nur-art-04.png') }}" data-rotate="0"
                            data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3=""
                            data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9=""
                            data-param10="" data-description="">
                            <!-- MAIN IMAGE - 01-->
                            <img src="{{ asset('images/nur-art-img/nur-art-04.png') }}" alt="sart_academy" data-bgposition="center center"
                            ...
                            <div class="tp-caption tp-resizeme text-primary" id="slide-100-layer-2"
                                ...
                                data-paddingleft="[0,0,0,0]"
                                style="z-index: 7; white-space: nowrap; font-size: 65px; line-height: 80px; font-weight: 600; letter-spacing: 0px; font-family:Poppins;">
                                <span class="notranslate">@lang('home.sart_academy')</span>
                            </div>
                            <div class="tp-caption tp-resizeme text-primary" id="slide-100-layer-3"
                                ...
                                data-paddingleft="[110,110,110,110]"
                                style="z-index: 7; white-space: nowrap; font-size: 65px; line-height: 80px; font-weight: 600; letter-spacing: 0px; font-family:Poppins;">
                                @lang('home.index_slide_1_2_academy')</div>
                            <!-- LAYER NR. 2 -->
                            <div class="tp-caption tp-resizeme" id="slide-100-layer-4"
                                ...
                                data-paddingleft="[0,0,0,0]"
                                style="z-index: 6; font-size: 18px; line-height: 28px; font-weight: 500; color: #fff; white-space: inherit; font-family:Poppins;">
                                @lang('home.index_slide_1_3_academy')
                            </div>
                            <!-- LAYER NR. 6 -->
                            <div class="tp-caption tp-resizeme" id="slide-100-layer-5"
                                ...
                                <a href="{{ uniqRt('contact-us') }}" class="site-button button-md"
                                    title="@lang('home.index_slide_1_contact_button_academy')" target="_self"> @lang('home.index_slide_1_contact_button_academy')</a>
                            </div>
                            ...
                            <div class="tp-caption tp-resizeme" id="slide-100-layer-6"
                                ...
                                <a href="{{ uniqRt('about-us') }}" class="site-button-secondry button-md"
                                    title="@lang('home.index_slide_1_about_button_academy')" target="_self">@lang('home.about_us')</a>
                            </div>
                        </li>
            ...
            <div class="container">
                <div class="section-head text-black text-center">
                    <div class="dlab-separator-outer m-b0">
                        <div class="dlab-separator text-primary style-icon"><img src="/images/nur-art-logos/nur-art-logo-06.png"
                                alt="@lang('home.sart_academy')">
                        </div>
                    </div>
                    <h2 class="text-primary m-b10">@lang('home.index_section1_main_title_academy')</h2>
                    <h6 class="m-b10">@lang('home.index_section1_subtitle_academy')</h6>
                    <p>@lang('home.index_section1_content1_academy')</p>
                </div>
                ...
                <div class="img-carousel owl-carousel owl-theme owl-none owl-dots-primary-big owl-btn-center-lr owl-loade m-b30">
                    ...
                    <div class="item">
                        <div class="service-box text-center">
                            ...
                            <div class="service-content">
                                <h6 class="text-uppercase">
                                    <a href="{{ uniqRt('silk-eyelash-academy') }}" class="text-primary"
                                        title="@lang('home.index_section1_slide1_title_academy')" target="_self">@lang('home.index_section1_slide1_title_academy')</a>
                                </h6>
                                <p>@lang('home.index_section1_slide1_cont_academy')</p>
                            </div>
                        </div>
                    </div>
                     <!-- Heýkel Sapagy -->
                     <div class="item">
                        <div class="service-box text-center">
                            ...
                            <div class="service-content">
                                <h6 class="text-uppercase">
                                    <a href="{{ uniqRt('permanent-makeup-academy') }}" class="text-primary"
                                        title="@lang('home.index_section1_slide3_alt_academy')" target="_self">@lang('home.index_section1_slide3_alt_academy')</a>
                                </h6>
                                <p>@lang('home.index_section1_slide3_cont_academy')</p>
                            </div>
                        </div>
                    </div>
                    <!-- Aýdym-Saz  Sapagy -->
                    <div class="item">
                        <div class="service-box text-center">
                            <div class="service-images m-b15">
                                <img width="300" height="300" src="{{ asset('images/nur-art-img/nur-art-010.png') }}"
                                    alt="@lang('home.index_section1_slide7_alt_academy')" />
                                <i class="flaticon-candle"></i>
                            </div>
                            <div class="service-content">
                                <h6 class="text-uppercase">
                                    <a href="{{ uniqRt('prosthetic-nails-academy') }}" class="text-primary"
                                        title="@lang('home.index_section1_slide7_alt_academy')" target="_self">@lang('home.index_section1_slide7_title_academy')</a>
                                </h6>
                                <p>@lang('home.index_section1_slide7_cont_academy')</p>
                            </div>
                        </div>
                    </div>
                    <!-- Keramika Sapagy -->
                    <div class="item">
                        <div class="service-box text-center">
                            <div class="service-images m-b15">
                                <img width="300" height="300" src="{{ asset('images/nur-art-img/nur-art-023.png') }}"
                                    alt="@lang('home.index_section1_slide8_alt_academy')" />
                                <i class="flaticon-candle-1"></i>
                            </div>
                            <div class="service-content">
                                <h6 class="text-uppercase">
                                    <a href="{{ uniqRt('hair-extension-academy') }}" class="text-primary"
                                        title="@lang('home.index_section1_slide8_alt_academy')" target="_self">@lang('home.index_section1_slide8_alt_academy')</a>
                                </h6>
                                <p>@lang('home.index_section1_slide8_cont_academy')</p>
                            </div>
                        </div>
                    </div>
                    <!-- Senetçilik Sapagy -->
                    <div class="item">
                        <div class="service-box text-center">
                            <div class="service-images m-b15">
                                <img width="300" height="300" src="{{ asset('images/nur-art-img/nur-art-013.png') }}"
                                    alt="@lang('home.index_section1_slide5_alt_academy')" />
                                <i class="flaticon-candle"></i>
                            </div>
                            <div class="service-content">
                                <h6 class="text-uppercase">
                                    <a href="{{ uniqRt('beauty-master-academy') }}" class="text-primary"
                                        title="@lang('home.index_section1_slide5_title_academy')" target="_self">@lang('home.index_section1_slide5_title_academy')</a>
                                </h6>
                                <p>@lang('home.index_section1_slide5_cont_academy')</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="section-full content-inner-2 our-portfolio">
            <div class="container">
                <div class="section-head text-black text-center m-b20">
                    <div class="dlab-separator-outer m-b0">
                        <div class="dlab-separator text-primary style-icon"><img src="{{ asset('images/nur-art-logos/nur-art-logo-06.png') }}"
                                alt="@lang('home.index_section2_img_alt_academy')"></div>
                    </div>
                    ...
                    <ul id="masonry"
                        ...
                        <li class="image-1  card-container col-lg-3 col-md-3 col-sm-3">
                            <div class="dlab-box">
                                <div class="dlab-media dlab-img-overlay9 dlab-img-effect zoom">
                                    <img width="385" height="385"img src="{{ asset('images/nur-art-img/nur-art-01.png') }}"
                                        alt="@lang('home.hair_extension')">
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            <span data-exthumbimage="{{ asset('images/nur-art-img/nur-art-01.png') }}"
                                                data-src="{{ asset('images/nur-art-img/nur-art-01.png') }}" class="icon-bx-xs check-km"
                            ...
                            <div class="dlab-box p-tb30 image-2">
                                <div class="dlab-media dlab-img-overlay9 dlab-img-effect zoom">
                                    <img width="385" height="385"img src="{{ asset('images/nur-art-img/nur-art-02.png') }}"
                                        alt="@lang('home.hair_dye')">
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            <span data-exthumbimage="{{ asset('images/nur-art-img/nur-art-02.png') }}"
                                                data-src="{{ asset('images/nur-art-img/nur-art-02.png') }}" class="icon-bx-xs check-km"
                        ...
                        <li class="image-2 card-container col-lg-6 col-md-6 col-sm-6">
                            <div class="dlab-box m-b30">
                                <div class="dlab-media dlab-img-overlay9 dlab-img-effect zoom">
                                    <img src="{{ asset('images/nur-art-img/nur-art-023.png')}}" alt="@lang('home.silk_eyelash')">
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            <span data-exthumbimage="{{ asset('images/nur-art-img/nur-art-023.png')}}"
                        ...
                        <li class="image-3 image-4 card-container col-lg-3 col-md-3 col-sm-3">
                            <div class="dlab-box m-b30">
                                <div class="dlab-media dlab-img-overlay9 dlab-img-effect zoom">
                                    <img width="385" height="385"img src="{{ asset('images/nur-art-img/nur-art-016.png') }}"
                                        alt="@lang('home.mani_pedi')">
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            <span data-exthumbimage="{{ asset('images/nur-art-img/nur-art-016.png') }}"
                            ...
                            <div class="dlab-box">
                                <div class="dlab-media dlab-img-overlay9 dlab-img-effect zoom">
                                    <img width="385" height="385"img src="{{ asset('images/nur-art-img/nur-art-07.png') }}"
                                        alt="@lang('home.solarium')">
                                    <div class="overlay-bx">
                                        <div class="overlay-icon">
                                            <span data-exthumbimage="{{ asset('images/nur-art-img/nur-art-07.png') }}"
                                                data-src="{{ asset('images/nur-art-img/nur-art-07.png') }}" class="icon-bx-xs check-km"
        ...
        <div class="section-full content-inner-2 overlay-white-middle"
            ...
            <div class="container">
                <div class="section-head text-black text-center">
                    <div class="dlab-separator-outer m-b0">
                        <div class="dlab-separator text-primary style-icon"><img src="/images/nur-art-logos/nur-art-logo-06.png"
                                alt="@lang('home.index_section4_img_alt_academy')">
                        </div>
                    </div>
                ...
                <div
                    ...
                    <div class="item">
                        <div class="dlab-box text-center team-box">
                            <div class="dlab-media"> <img width="300" height="300"img
                                    src="/images/nur-art-img/nur-art-031.png" alt="@lang('home.')Kaş Laminasyon"></div>
