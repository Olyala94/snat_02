	...
	var dzTheme = function(){
		...
		if(screenWidth < 991)
		{
			if($('.mo-left .header-nav').children('div').length == 0){
				...
				jQuery('.mo-left .header-nav .logo-header > a > img').attr('src','/images/sart/favicon.png');
				jQuery('.mo-left.lw .header-nav .logo-header > a > img').attr('src','/images/sart/favicon.png');
			}
		}else{
	...
	var scrollTop = function (){
		...
		jQuery(window).bind("scroll", function() {
			...
			if (scroll > 900) {
				...
				jQuery("button.scroltop").fadeOut(500);
			}
		});
